...
func main() {
	...
	dbUser := getEnv("DB_USER", "hafalan_user")
	dbPass := getEnv("DB_PASSWORD", "hafalan_pass")
	...
	_, err = tx.Exec(`
			...
			(5, 'Orang Tua Tester', '081234567893', 'male'),
			(6, 'Bapak Ahmad', '081234567894', 'male'),
			(7, 'Ibu Siti', '081234567895', 'female'),
			(8, 'Bapak Hasan Basri', '081234567896', 'male'),
			(9, 'Ibu Fatimah Az-Zahra', '081234567897', 'female')
			ON CONFLICT (user_id) DO NOTHING
		`)
	if err != nil {
